var json = {
    ...
    ,
    {
        ...
        "time": "27 Jan 2022",
        "Link": "http://127.0.0.1:5500/HTML/htmlquiz/quiz.html",
        "distributor": "Bihar BPSC Assistant Audit Officer AAO Online Form 2021",
        "category": "(HTML)"
    }
    ,
    {
...
$('#list').pagination({ // you call the plugin
  ...
  callback: function(data, pagination) {
      ...
      $.each(data, function (i, f) {
         $('#list .wrapper').append('<ul class="listview"><li class="item" ><a href="' + f.Link + '">'+f.distributor+' <font color="#0F94F6"><span>'+f.category+'</span></font></a></li></ul>');
      });
    }
   });
