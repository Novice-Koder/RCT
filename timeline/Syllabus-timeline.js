...
$('#syllabuslist').pagination({ // you call the plugin
  ...
  callback: function(data, pagination) {
      ...
      var wrapper = $('#syllabuslist .syllabuswrapper').empty();
      $.each(data, function (i, f) {
         $('#syllabuslist .syllabuswrapper').append('<ul class="listview"><li class="item" ><a href="' + f.Link + '">'+f.distributor+' <font color="#0F94F6"><span>'+f.category+'</span></font></a></li></ul>');
      });
    }
   });
